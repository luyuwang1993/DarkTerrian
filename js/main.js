...
function createMap() {
    ...
    var apitoken = 'pk.eyJ1Ijoid2FuZ2x1eXUiLCJhIjoiY2sybmlnbG93MHQ2ZzNjbTk4ajFyNG8zMyJ9.qKQmSZ6cuolQt6NDbbl9uA'; //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var darkTerrain = L.tileLayer(mbStyleUrl, {id: 'wangluyu/ck2nik6wt1ahu1dnvdtlcxyhj', token: apitoken,  attribution: mbAttr});
